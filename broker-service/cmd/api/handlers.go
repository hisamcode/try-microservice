...
import (
	...
	"github.com/hisamcode/try-microservice/broker-service/event"
	"github.com/hisamcode/try-microservice/broker-service/logs"
...
func (app *application) logItemViaRPC(w http.ResponseWriter, l LogPayload) {
